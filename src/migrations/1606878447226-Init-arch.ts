...
export class InitArch1606878447226 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`INSERT INTO "user" ("id", "firstName", "lastName", "login", "passwordHash", "role", "deleted", "createdAt", "updatedAt") VALUES (1, 'Mark', 'First', 'mark', '$2a$10$MA0PkJP6CU4krmYuDSNL1uMGCjyOKs6FLIF/atqsMqubwv21TEGK2', 'user', FALSE, NOW(), NOW());`)
        ...
        await queryRunner.query(`INSERT INTO "user" ("id", "firstName", "lastName", "login", "passwordHash", "role", "deleted", "createdAt", "updatedAt") VALUES (2, 'Leon', 'Second', 'leon', '$2a$10$MA0PkJP6CU4krmYuDSNL1uMGCjyOKs6FLIF/atqsMqubwv21TEGK2', 'user', FALSE, NOW(), NOW());`)
        ...
        await queryRunner.query(`INSERT INTO "user" ("id", "firstName", "lastName", "login", "passwordHash", "role", "deleted", "createdAt", "updatedAt") VALUES (3, 'Andrew', 'Third', 'andrew', '$2a$10$MA0PkJP6CU4krmYuDSNL1uMGCjyOKs6FLIF/atqsMqubwv21TEGK2', 'user', FALSE, NOW(), NOW());`)
